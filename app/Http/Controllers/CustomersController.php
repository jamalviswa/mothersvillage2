...
class CustomersController extends Controller
{
    ...
    public function personal_delete(Request $request, $id = null)
    {
        ...
        $costs = Cost::where('customer_id', '=', $id)->get();
        ...
        foreach ($receipts as $receipt) {
            $last = $receipt['receipt_id'];
            $data = Receipt::findOrFail($last);
            $data->status = 'Trash';
            $data->save();
        }
...
// personal details table pdf function

public function personal_tablepdf()
{
    $sessionadmin = Parent::checkadmin();
    $pdf = PDF::loadView('customers/personal_tableform');
    //$dates = Customer::where('status', 'Active')->get();
    $file_name =  'Personal_Details';
    return $pdf->download($file_name . '.pdf');
}

public function personal_tableform()
{
    $sessionadmin = Parent::checkadmin();
    return view('customers/personal_tableform');
}

// Document details table pdf function

public function official_tablepdf()
{
    $sessionadmin = Parent::checkadmin();
    $pdf = PDF::loadView('customers/official_tableform');
    //$dates = Customer::where('status', 'Active')->get();
    $file_name =  'Document_Details';
    return $pdf->download($file_name . '.pdf');
}

public function official_tableform()
{
    $sessionadmin = Parent::checkadmin();
    return view('customers/official_tableform');
}
