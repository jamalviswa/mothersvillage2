...
Route::get('customers/personal/tablepdf', 'CustomersController@personal_tablepdf')->name('customers.personal_tablepdf');
Route::get('customers/personal/tableform', 'CustomersController@personal_tableform')->name('customers.personal_tableform');
...
Route::get('customers/official/tablepdf', 'CustomersController@official_tablepdf')->name('customers.official_tablepdf');
Route::get('customers/official/tableform', 'CustomersController@official_tableform')->name('customers.official_tableform');
