                    ...
                    <div class="m-section__content">
                        <?php if ($results->count() > '0') { ?>
                            <div class="download_pdf">
                                <a rel="tooltip" style="background: #0054ac;" class="btn btn-secondary m-btn m-btn--air m-btn--custom" title="Download" href="{{ route('customers.personal_tablepdf') }}" target="_blank" download>
